...
import { CatalogSecondLevel } from 'components/pages/CatalogSecondAndThirdLevel';
...
const CatalogSecondLevelPage = (): ReactElement => <CatalogSecondLevel />;

export default CatalogSecondLevelPage;
