...
import { CatalogThirdLevel } from 'components/pages/CatalogSecondAndThirdLevel';
...
const CatalogThirdLevelPage = (): ReactElement => <CatalogThirdLevel />;

export default CatalogThirdLevelPage;
